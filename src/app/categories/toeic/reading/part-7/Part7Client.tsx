...
interface Part7ClientProps {
  tests: Test[];
}

export default function Part7Client({ tests }: Part7ClientProps) {
  ...
  const difficulties = [
    { label: 'ทั้งหมด', value: 'ทั้งหมด', count: tests.length, color: 'green' },
  ...
  return (
    <div className="pb-20">
      {/* Stats Section */}
      <div className="bg-gradient-to-b from-green-600/5 to-transparent dark:from-green-900/10 py-12">
      ...
      <div className="container mx-auto px-6">
        ...
        {filteredTests.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredTests.map((test, index) => (
              ...
              >
                <div className="relative h-full bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-green-300 dark:hover:border-green-700 transform hover:-translate-y-2">
                  ...
                  <div className="relative p-6 pt-24">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t-2 border-gray-100 dark:border-gray-700">
                      <span className="text-green-600 dark:text-green-400 font-bold group-hover:text-green-700 dark:group-hover:text-green-300">
                        เริ่มทำข้อสอบ
                      </span>
                      <svg 
                        className="w-6 h-6 text-green-600 dark:text-green-400 transform group-hover:translate-x-2 transition-transform" 
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                      >
          ...
          <div className="text-center py-20">
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all"
            >
              ดูชุดข้อสอบทั้งหมด
            </button>
          </div>
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 dark:from-green-900/20 dark:via-emerald-900/20 dark:to-teal-900/20 rounded-3xl p-8 border-2 border-green-200 dark:border-green-800 shadow-xl">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                  <span>💡</span>
                  <span>เทคนิคการทำ Part 7 ให้ได้คะแนนเต็ม</span>
                </h3>
                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    ...
                    <div>
                      <span className="font-bold text-gray-900 dark:text-white">อ่านคำถามก่อน: </span>
                      <span className="text-gray-700 dark:text-gray-300">อ่านคำถามก่อนอ่านบทความ จะทำให้รู้ว่าต้องมองหาข้อมูลอะไร</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    <div className="flex-shrink-0 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mt-0.5">
                    ...
                    <div>
                      <span className="font-bold text-gray-900 dark:text-white">Skim & Scan: </span>
                      <span className="text-gray-700 dark:text-gray-300">Skim เพื่อจับใจความหลัก แล้ว Scan เพื่อหารายละเอียดที่ต้องการ</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    <div className="flex-shrink-0 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mt-0.5">
                    ...
                    <div>
                      ...
                      <span className="text-gray-700 dark:text-gray-300">คำตอบมักใช้คำพูดแบบอื่นที่มีความหมายเดียวกับในบทความ</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    <div className="flex-shrink-0 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center mt-0.5">
                    ...
                    <div>
                      <span className="font-bold text-gray-900 dark:text-white">จัดการเวลา: </span>
                      <span className="text-gray-700 dark:text-gray-300">Single passages ใช้เวลาน้อยกว่า Double/Triple passages ควรทำง่ายๆ ก่อน</span>
                    </div>
                  </div>
                </div>
              </div>
