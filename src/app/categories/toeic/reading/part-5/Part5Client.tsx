...
interface Part5ClientProps {
  tests: Test[];
}

export default function Part5Client({ tests }: Part5ClientProps) {
  ...
  const difficulties = [
    { label: 'ทั้งหมด', value: 'ทั้งหมด', count: tests.length, color: 'purple' },
  ...
  return (
    <div className="pb-20">
      {/* Stats Section - ไม่ใช้ negative margin แล้ว */}
      <div className="bg-gradient-to-b from-purple-600/5 to-transparent dark:from-purple-900/10 py-12">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border-2 border-purple-200 dark:border-purple-900 transform hover:scale-105 transition-all">
      ...
      <div className="container mx-auto px-6">
        ...
        {filteredTests.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredTests.map((test, index) => (
              ...
              >
                <div className="relative h-full bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-purple-300 dark:hover:border-purple-700 transform hover:-translate-y-2">
                  ...
                  <div className="relative p-6 pt-24">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t-2 border-gray-100 dark:border-gray-700">
                      <span className="text-purple-600 dark:text-purple-400 font-bold group-hover:text-purple-700 dark:group-hover:text-purple-300">
                        เริ่มทำข้อสอบ
                      </span>
                      <svg 
                        className="w-6 h-6 text-purple-600 dark:text-purple-400 transform group-hover:translate-x-2 transition-transform" 
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                      >
          ...
          <div className="text-center py-20">
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all"
            >
              ดูชุดข้อสอบทั้งหมด
            </button>
          </div>
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 dark:from-purple-900/20 dark:via-pink-900/20 dark:to-rose-900/20 rounded-3xl p-8 border-2 border-purple-200 dark:border-purple-800 shadow-xl">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                  <span>💡</span>
                  <span>เทคนิคการทำ Part 5 ให้ได้คะแนนเต็ม</span>
                </h3>
                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    ...
                    <div>
                      <span className="font-bold text-gray-900 dark:text-white">อ่านทั้งประโยค: </span>
                      <span className="text-gray-700 dark:text-gray-300">อย่าเพิ่งตอบจากคำว่างเพียงอย่างเดียว ต้องอ่านทั้งประโยคเพื่อเข้าใจบริบท</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    <div className="flex-shrink-0 w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center mt-0.5">
                    ...
                    <div>
                      <span className="font-bold text-gray-900 dark:text-white">จับเวลา: </span>
                      <span className="text-gray-700 dark:text-gray-300">ควรใช้เวลาไม่เกิน 30 วินาทีต่อข้อ เพื่อให้เหลือเวลาสำหรับ Part อื่นๆ</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    <div className="flex-shrink-0 w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center mt-0.5">
                    ...
                    <div>
                      <span className="font-bold text-gray-900 dark:text-white">เน้นไวยากรณ์: </span>
                      <span className="text-gray-700 dark:text-gray-300">มักจะเป็นการทดสอบ Verb Tense, Preposition, Conjunction และ Pronoun</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    <div className="flex-shrink-0 w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center mt-0.5">
                    ...
                    <div>
                      <span className="font-bold text-gray-900 dark:text-white">อ่านตัวเลือก: </span>
                      <span className="text-gray-700 dark:text-gray-300">ก่อนดูประโยค ถ้าเป็นคำประเภทเดียวกัน จะทำให้รู้ว่าต้องดูไวยากรณ์ ถ้าต่างกันให้ดูความหมาย</span>
                    </div>
                  </div>
                </div>
              </div>
