...
interface Part1ClientProps {
  tests: Test[];
}

export default function Part1Client({ tests }: Part1ClientProps) {
  ...
  const difficulties = [
    { label: 'ทั้งหมด', value: 'ทั้งหมด', count: tests.length, color: 'pink' },
  ...
  return (
    <div className="pb-20">
      {/* Stats Section */}
      <div className="bg-gradient-to-b from-pink-600/5 to-transparent dark:from-pink-900/10 py-12">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border-2 border-pink-200 dark:border-pink-900 transform hover:scale-105 transition-all">
      ...
      <div className="container mx-auto px-6">
              ...
              <button
                ...
                className={`px-6 py-3 rounded-xl font-semibold shadow-md transition-all transform hover:scale-105 ${
                  selectedDifficulty === difficulty.value
                    ? difficulty.color === 'pink'
                      ? 'bg-gradient-to-r from-pink-600 to-rose-600 text-white shadow-pink-500/50'
        ...
        {filteredTests.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredTests.map((test, index) => (
              ...
              >
                <div className="relative h-full bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-pink-300 dark:hover:border-pink-700 transform hover:-translate-y-2">
                  ...
                  <div className="relative p-6 pt-24">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t-2 border-gray-100 dark:border-gray-700">
                      <span className="text-pink-600 dark:text-pink-400 font-bold group-hover:text-pink-700 dark:group-hover:text-pink-300">
                        เริ่มทำข้อสอบ
                      </span>
                      <svg 
                        className="w-6 h-6 text-pink-600 dark:text-pink-400 transform group-hover:translate-x-2 transition-transform" 
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                      >
          ...
          <div className="text-center py-20">
            <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-pink-100 to-rose-100 dark:from-pink-900/30 dark:to-rose-900/30 rounded-full mb-6">
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-pink-600 to-rose-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all"
            >
              ดูชุดข้อสอบทั้งหมด
            </button>
          </div>
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-pink-50 via-rose-50 to-red-50 dark:from-pink-900/20 dark:via-rose-900/20 dark:to-red-900/20 rounded-3xl p-8 border-2 border-pink-200 dark:border-pink-800 shadow-xl">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                  <span>💡</span>
                  <span>เทคนิคการทำ Part 1 ให้ได้คะแนนเต็ม</span>
                </h3>
                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    ...
                    <div>
                      <span className="font-bold text-gray-900 dark:text-white">สังเกตรายละเอียดในภาพ: </span>
                      <span className="text-gray-700 dark:text-gray-300">จดจ่อกับคน, สิ่งของ, สถานที่, และการกระทำในภาพ</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    <div className="flex-shrink-0 w-6 h-6 bg-pink-500 rounded-full flex items-center justify-center mt-0.5">
                    ...
                    <div>
                      <span className="font-bold text-gray-900 dark:text-white">ฟังให้ชัดเจน: </span>
                      <span className="text-gray-700 dark:text-gray-300">ตั้งใจฟังทุกตัวเลือก อย่าเพิ่งตัดสินใจเร็วเกินไป</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    <div className="flex-shrink-0 w-6 h-6 bg-pink-500 rounded-full flex items-center justify-center mt-0.5">
                    ...
                    <div>
                      <span className="font-bold text-gray-900 dark:text-white">ระวังคำที่คล้ายกัน: </span>
                      <span className="text-gray-700 dark:text-gray-300">คำที่เสียงคล้ายกันอาจทำให้สับสน เช่น "walk" และ "work"</span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-800/60 rounded-xl">
                    <div className="flex-shrink-0 w-6 h-6 bg-pink-500 rounded-full flex items-center justify-center mt-0.5">
                    ...
                    <div>
                      <span className="font-bold text-gray-900 dark:text-white">เลือกที่ตรงที่สุด: </span>
                      <span className="text-gray-700 dark:text-gray-300">อาจมีหลายข้อที่ดูถูกบางส่วน แต่เลือกข้อที่บรรยายภาพได้ครบถ้วนที่สุด</span>
                    </div>
                  </div>
                </div>
              </div>
