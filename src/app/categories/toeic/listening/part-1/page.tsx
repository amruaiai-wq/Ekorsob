// app/categories/toeic/listening/part-1/page.tsx
...
export default async function Part1Page() {
  ...
  // ดึงข้อมูลชุดข้อสอบ Part 1 จาก Database
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 dark:from-gray-900 dark:via-gray-800 dark:to-pink-950">
      {/* Header Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-pink-600 via-rose-600 to-red-600 dark:from-pink-800 dark:via-rose-800 dark:to-red-800">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-lg md:text-xl text-white/90">
                ดูรูปภาพและฟังคำบรรยาย | 6 ข้อต่อชุด
              </p>
            </div>
          </div>
        </div>
